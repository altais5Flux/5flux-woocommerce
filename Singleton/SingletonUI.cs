...
namespace WebservicesSage.Singleton
{
    public sealed class SingletonUI
    {
        ...
        public System.Windows.Forms.ComboBox select_categorie_tarifaire { get; set; }
        public System.Windows.Forms.ComboBox choix_Depot { get; set; }
        ...
        public WindowsFormsControlLibrary1.BunifuCustomTextbox CS { get; set; }
