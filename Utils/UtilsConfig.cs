...
namespace WebservicesSage.Utils
{
    static class UtilsConfig
    {
        ...
        public static string Token
        {
            get
            {
                return ConfigurationManager.AppSettings["CK"];
            }
            set
            {
        ...
        public static string Consumer_key
        {
            ...
            set
            {
                UpdateConfig("CK", value.ToString());
            }
        }

        public static string CategorieTarif
        {
            get
            {
                return ConfigurationManager.AppSettings["CategorieTarif"];
            }
            set
            {
                UpdateConfig("CategorieTarif", value.ToString());
            }
        }
        ...
        public static string Depot
        {
            ...
            set
            {
                UpdateConfig("Depot", value.ToString());
            }
        }
        ...
        public static string CS
        {
            ...
            set
            {
                UpdateConfig("CS", value.ToString());
            }
        }
